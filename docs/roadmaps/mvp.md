...
graph LR
	...
	4GLY.1 --> M4
	4PHON.2 --> M4
	class 1ENG.17,1ENG.21,1ENG.23,1ENG.24,2GEO.6,2LEX.3,2LEX.5,2MAP.1,2NAR.1,2NAR.3,2SIM.1,2STK.4,2STK.6,2STK.7,3PER.1 todo
	class 2GEO.7,2GEO.8,2GLY.1,2GLY.2,2GLY.3,2GLY.4,2LEX.4,2LEX.6,2MAP.2,2NAR.2,2NAR.4,2UI.1,2UI.2,2UI.3,3SHR.1,4PHON.1 blocked
